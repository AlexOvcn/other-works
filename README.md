# Что это?
### Это библиотека для взаимодействия с базой данных из javascript. Представляет из себя удобный интерфейс для получения необходимых данных из базы данных MySQL.
***
# Какие задачи решает?
